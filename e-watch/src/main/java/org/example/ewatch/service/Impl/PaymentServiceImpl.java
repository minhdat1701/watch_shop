...
import org.example.ewatch.config.PaymentConfig;
...
import org.example.ewatch.repository.PaymentRepository;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public String generatePaymentUrl(Order order, String returnUrl) throws UnsupportedEncodingException {
        int total = (int) (order.getTotalPrice() * 1000);
        String orderInfor = String.valueOf(order.getId());
        return createOrder(total, orderInfor, returnUrl);
    }
    ...
    public void updatePaymentStatus(Long orderId, String paymentStatus) {
        ...
        Payment payment = paymentRepository.findByOrder(order).orElseThrow(() -> new NotFoundException("Payment not found"));
